...
w = tf.compat.v1.Variable(tf.random_normal([x_data.shape[1],1]),shape=(x_data.shape[1],1),name='weight')
...
plt.legend()
plt.subplot(1,2,2) 
plt.plot(y_test,color='blue',label='y_test',marker='.')
plt.plot(pred,color='red',label='y_pred',marker='.')
plt.legend()
plt.show()

# r2: -0.2209720157449726  |  mae: 0.972016448208685