...
x_train = scaler.transform(x_train).reshape(x_train.shape[0],2,2,2)
x_test = scaler.transform(x_test).reshape(x_test.shape[0],2,2,2)
test_csv = scaler.transform(test_csv).reshape(test_csv.shape[0],2,2,2)
