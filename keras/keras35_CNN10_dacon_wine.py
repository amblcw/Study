...
x_train = scaler.transform(x_train).reshape(x_train.shape[0],3,2,2)
x_test = scaler.transform(x_test).reshape(x_test.shape[0],3,2,2)
test_csv = scaler.transform(test_csv).reshape(test_csv.shape[0],3,2,2)
...
# CNN 
# LOSS: 1.0377037525177002
#  ACC:  0.5463636363636364(0.5463636517524719 by loss[1])