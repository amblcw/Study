...
# model
model = Sequential()
model.add(Conv2D(filters=30, kernel_size=(2,2), strides=2, input_shape=(28,28,1))) #Conv2D(filter:출력갯수,kernel_size=(2,2),input_shape=(28,28,1))
# model.add(Dropout(0.05))
model.add(Conv2D(20, (2,2), strides=2))
model.add(Conv2D(10, (2,2), strides=2))
...
# augment
# time: 113.74138355255127sec
# LOSS: 0.10404343158006668
