...
hist = model.fit(x_train,y_train,epochs=4096,batch_size=16,validation_split=0.3,verbose=2,callbacks=[es])
...
submit_csv.to_csv(path+f"wine_{dt.day}day{dt.hour:2}{dt.minute:2}_ACC{loss[1]:.2f}.csv",index=False)
