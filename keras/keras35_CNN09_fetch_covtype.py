...
x_train = scaler.transform(x_train).reshape(x_train.shape[0],9,6,1)
x_test = scaler.transform(x_test).reshape(x_test.shape[0],9,6,1)
...
hist = model.fit(x_train,y_train,epochs=123456,batch_size=40000,validation_split=0.2, verbose=2,callbacks=[es,mcp])
end_time = time.time()
#evaluate & predict
...
# ACC:  0.7627134202313199(0.7627134323120117 by loss[1])