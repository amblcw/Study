...
print(hist.keys())
plt.plot(hist['validation_0']['mae'], label='val_by_train', color='red')
plt.plot(hist['validation_1']['mae'], label='val_by_test', color='blue')
plt.grid()
plt.legend()
plt.show()
...
'''
LGBM은 데이터가 1만개 이하일시 성능이 제대로 안 나온다
'''