...
# model
model = HalvingGridSearchCV(SVR(),param, cv=kfold,verbose=1,refit=True,n_jobs=-1, factor=3)
...
시작 데이터 개수 = CV * 2 + alpha 의 개수 (라고 되어는 있지만 알고리즘에 의해 조금씩 틀어짐)(alpha는 내부 알고리즘에 의한 조정값)
'''
# n_iterations: 3
