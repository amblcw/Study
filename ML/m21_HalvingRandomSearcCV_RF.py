...
from sklearn.model_selection import train_test_split, KFold, cross_val_score, StratifiedKFold, cross_val_predict, GridSearchCV, RandomizedSearchCV, HalvingGridSearchCV, HalvingRandomSearchCV
...
# model
model = HalvingRandomSearchCV(SVC(),param, cv=3,verbose=1,refit=True,factor=3, min_resources=159)
