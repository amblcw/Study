...
# model = Pipeline(MinMaxScaler(),StandardScaler(),PCA(),RandomForestClassifier())
model = Pipeline([('mm',MinMaxScaler()), ('st',StandardScaler()),('PCA',PCA()),('rf',RandomForestClassifier())])
